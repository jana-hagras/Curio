...
export default function ProductCard({ product, onAddToCart, layoutClass = "" }) {
  ...
  return (
    <Link to={`/marketplace/${product.id}`} className={`product-card ${layoutClass}`} id={`product-card-${product.id}`}>
